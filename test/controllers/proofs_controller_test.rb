...
class ProofsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proof" do
    assert_difference('Proof.count') do
      post proofs_url, params: { proof: { content: @proof.content, type_proof: @proof.type_proof } }
    end
  ...
  test "should update proof" do
    patch proof_url(@proof), params: { proof: { content: @proof.content, type_proof: @proof.type_proof } }
